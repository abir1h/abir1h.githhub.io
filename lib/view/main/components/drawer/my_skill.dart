...
class MySKills extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const Column(
      ...
      children: [
        AnimatedLinearProgressIndicator(percentage: .9, title: 'Flutter',image: 'assets/icons/flutter.png',),
        ...
        AnimatedLinearProgressIndicator(percentage: 1, title: 'Clean Architecture',image: 'assets/icons/flutter.png'),
        AnimatedLinearProgressIndicator(percentage: 0.5, title: 'Bloc',image: 'assets/icons/bloc.png'),
        AnimatedLinearProgressIndicator(percentage: 1, title: 'Getx',image: 'assets/icons/dart.png'),
      ],);
  }
}
